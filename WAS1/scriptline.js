...
pitchInput.addEventListener('change',function(){
  pitchIndicator.textContent = pitchInput.value
	...
	function speak() {
		...
		var stringToSpeech =" MOHON PERHATIAN !, PANGGILAN KEPADA : " +txtPanggilan.value +", SECTION : " +txtSection.value +" DIMOHON SEGERA MENUJU LINE : "+txtLine.value +" LOT : "+txtLot.value+" LANTAI : "+txtLantai.value+" TERIMAKASIH";
