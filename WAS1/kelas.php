...
<nav class="navbar navbar-light" style="background-color: #e3f2fd;">
    ...
    <div class=" pt-5 text-center">
        <div class="card text-center mb-3" style="margin: auto; width: 15%; padding: 10px;">
            <h5 class="card-text" style="color: black; font-weight: bolder;">DESKRIPSI PEMANGGILAN</h5>
        </div>

        <div class="container form-group">
            <label for="">Panggilan Kepada </label>
            <input type="text"class='form-control' style="width:450px; height:65px; margin: auto;" id="panggilan" value="marto"><br/>
        ...
        <div class="container form-group">
            ...
            <input type="text" class='form-control' style="width:450px; height:65px; margin: auto;" id="section" value="informatika"><br/>
        </div>
        <div class="container form-group">
