...
<nav class="navbar navbar-light" style="background-color: #e3f2fd;">
    ...
    <div class=" pt-5 text-center">
        ...
        <div class="container form-group">
            <label for="">Tempat Pertemuan</label>
            <input type="text" name="search" id="tempatpertemuan"  class="form-control" placeholder="nama ..." autocomplete="off"  style="height:65px;" required >
                <div class="list-group" id="show-tempatpertemuan">
                    <!-- Here autocomplete list will be display -->
                </div>
        </div>
        <div class="container form-group">
            <label for="">Meeting</label>
            <input type="text" class='form-control' style="height:65px;" id="meeting" value=""><br/>
        </div>
    ...
    <script src='scriptmeeting.js'></script>
</body>
</html>
