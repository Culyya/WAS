    ...
    <div class=" pt-5 text-center">
        ...
        <div class="container form-group">
            <label for="">Panggilan Kepada </label>
                <input type="text"  id="panggilan"  class="form-control" placeholder="nama ..." autocomplete="off"  style="height:65px;" required >
        ...
        <div class="container form-group">
            ...
            <input type="text"  id="section"  class="form-control" placeholder="nama ..." autocomplete="off"  style="height:65px;" required >
        ...
        <div class="container form-group">
            <label for="">ekstension</label>
            <input type="text" class='form-control' id="extension" value="123" style="height:65px;">
        </div>
        ...
        <div class="container form-group">
            <button id="btnspeak" class="btn btn-primary btn-block btn-lg" onclick="setTimeout(speak, 3000)" >Memulai Pemanggilan</button>
        </div>
    </div>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script>
    <script src="search.js"></script>
    <script src='scriptextension.js'></script>
</body>
</html>
