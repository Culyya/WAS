...
<nav class="navbar navbar-light" style="background-color: #e3f2fd;">
    ...
    <div class=" pt-5 text-center">
        ...
        <div class="container form-group">
            <label for="">Pemanggil</label>
            <input type="text" class='form-control' style="height:65px;" id="pemanggil" value="agung">
        </div>
        ...
        <div class="container form-group">
            <table style="margin-left:auto;margin-right:auto"  borde="">
                ...
                <tr>
                    <td>
                        <input type="text" class='form-control' style="width:225px; height:30px; margin: auto;" id="asalperusahaan" value="sumitomo"><br/>
                    </td>
                    <td>
                        <input type="text"class='form-control' style="width:225px; height:30px; margin: auto;" id="tempatpertemuan" value="kampus"><br/>
                    </td>
                </tr>
            </table>
        </div>
    ...
    <script src='scriptvendor.js'></script>
</body>
</html>
