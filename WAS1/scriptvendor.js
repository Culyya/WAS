...
pitchInput.addEventListener('change',function(){
  pitchIndicator.textContent = pitchInput.value
	...
	function speak() {
		...
		var txtPemanggil = document.querySelector('#pemanggil');
        var txtAsalperusahaan = document.querySelector('#asalperusahaan');
        var txtTempatpertemuan = document.querySelector('#tempatpertemuan');
		var btnSpeak = document.querySelector('#btnSpeak');
		var stringToSpeech =` MOHON PERHATIAN !, PANGGILAN KEPADA : ${txtPanggilan.value}, SECTION : ${txtSection.value}, DIMOHON SEGERA MENEMUI : ${txtPemanggil.value}, DARI PERUSAHAAN: ${txtAsalperusahaan.value},DI TEMPAT :${txtTempatpertemuan.value} TERIMA KASIH:`;
